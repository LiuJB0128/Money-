...
export const mockItemSummary: Mock = (config) => {
  ...
  if (group_by === 'happen_at' && kind === 'expenses') {
    ...
    return [
      ...
      {
        groups: [
          { happen_at: '2023-03-08T00:00:00.000+0800', amount: 100 },
          { happen_at: '2023-03-12T00:00:00.000+0800', amount: 300 },
    ...
    return [
      ...
      {
        groups: [
          { tag_id: 1, tag: { id: 1, name: '1234', sign: faker.internet.emoji() }, amount: 100 },
